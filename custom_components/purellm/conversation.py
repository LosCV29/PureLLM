...
from .tools import white_noise_sound as white_noise_sound_tool
    ...
    async def _execute_tool(
        ...
        try:
            ...
            tool_handlers = {
                ...
                "set_white_noise_sound": lambda: white_noise_sound_tool.set_white_noise_sound(arguments, self.hass),
