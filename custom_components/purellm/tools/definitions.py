...
def build_tools(config: "ToolConfig") -> list[dict]:
    ...
    tools.append(_tool(
        "control_device",
        "Control devices (lights, switches, locks, fans, covers, media_player). Use device name for fuzzy matching. Covers: open/close/stop. Media: pause/resume/play/mute/unmute. ALWAYS use this for specific device commands (e.g. 'resume the TV', 'pause the TV').",
        {
